...
import { raccoonSearchEditorProviderViewType, extensionNameKebab } from '../globalEnv';
  ...
  public async resolveCustomEditor(
    ...
    webviewPanel.webview.onDidReceiveMessage(
      (e) => {
        switch (e.type) {
          case 'open': {
            commands.executeCommand('vscode.openWith', Uri.parse(e.uri), raccoonSearchEditorProviderViewType);
            break;
          }
          case 'more': {
            let page = e.value ?? 1;
